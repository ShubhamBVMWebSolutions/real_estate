...
<head>
    ...
    <title>Agent - Dashboard - Gallery</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <form
                                    action="{{ route('property_gallery_update', Crypt::encrypt(['id' => $property->id])) }}"
                                    method="POST" enctype="multipart/form-data" style="" id="uploadForm">
                                    @csrf
                                    <label for="fileInput">
        ...
        <div class="modal fade" id="zoomimageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel"
            aria-hidden="true">
